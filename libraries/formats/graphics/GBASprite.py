...
def decodeGBASprite(data, romName, sectionIndex):
            ...
            if spriteOffset != 0:
                ...
                for animation in range(animationCount):
                    ...
                    for frame in range(frameCount):
                        ...
                        if chunkShape != None:
                            spriteImage.save(os.getcwd()+f"/output/{romName}/sprites/{sectionIndex:06}_{entry:04}_{animation:02}_{frame:02}.png")
